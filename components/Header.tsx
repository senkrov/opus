...
const Header: React.FC<HeaderProps> = ({ onSearchClick, activeFilter, onFilterChange }) => {
  return (
    <header className="sticky top-0 z-30 bg-[#0D1117]/80 backdrop-blur-md border-b border-gray-800">
      <div className="flex items-center justify-between w-full max-w-5xl mx-auto px-4 py-3 text-gray-400">
        <div className="flex-1 flex justify-start min-w-0">
          <span className="font-medium text-base sm:text-lg text-gray-400 whitespace-nowrap truncate">
            nev senkrov
          </span>
        </div>
